                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td id="grade{{$v->id.$f->id}}">
                                        <a paixu="{{$f->grade}}" href="form_basic.html#gradexiugai{{$v->id}}" data-toggle="modal" onclick="xiugaichengji{{$v->id.$f->id}}()">
                                            {{$f->grade}}
                                        </a>
                                    </td>
                        ...
                        <div class="col-sm-12">
                            ...
                            <form role="form" action="/grade/add" method="POST"  class="form-horizontal"  onsubmit="return check()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <select class="col-sm-3" name="id" id="xuehao" style="height: 30px;">
                                        @foreach ($stu as $v)
                                          <option>{{$v->id}}</option>
                                        @endforeach
                                      </select>
